...
export class GoogleAnalyticsTracker {
   ...
   */
  trackScreenViewWithCustomDimensionAndMetricValues(screenName, customDimensionValues,customMetricValues) {
    const formattedCustomDimensions = this.transformCustomDimensionsFieldsToIndexes(customDimensionValues);
    GoogleAnalyticsBridge.trackScreenViewWithCustomDimensionAndMetricValues(this.id, screenName, formattedCustomDimensions,customMetricValues);
  }
