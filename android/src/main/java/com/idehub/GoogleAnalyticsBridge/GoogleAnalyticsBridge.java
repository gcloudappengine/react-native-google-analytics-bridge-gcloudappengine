...
public class GoogleAnalyticsBridge extends ReactContextBaseJavaModule {
    ...
    //JAMH add method
    @ReactMethod
    public void trackScreenViewWithCustomDimensionAndMetricValues(String trackerId, String screenName, ReadableMap dimensionIndexValues,ReadableMap metricIndexValues)
    {
        Tracker tracker = getTracker(trackerId);
        ...
        if (tracker != null)
        {
            ...
            if(metricIndexValues != null){
                ...
                while (metricIterator.hasNextKey()) {
                    ...
                    String metricValue = metricIndexValues.getString(metricIndex);
                    screenBuilder.setCustomMetric(Integer.parseInt(metricIndex), Integer.parseInt(metricValue));
                }
            }
